...
//!
//! Usage:
//!     groqfmt query.groq                    # Format file to stdout
//!     groqfmt -w query.groq                 # Format file in-place
//!     groqfmt '*[_type == "article"]'       # Format query string
//!     echo '*[_type == "article"]' | groqfmt  # Format from stdin
...
use clap::Parser;
use groqfmt::{DEFAULT_WIDTH, format_query};
use tempfile::NamedTempFile;

#[derive(Parser)]
#[command(name = "groqfmt")]
